...
export type GetOrganizationDataResponse = InferResponseType<typeof hono.organizations.data.$get, 200>;
...
const getOrganizationData = async (organizationId: string, userId: string) => {
